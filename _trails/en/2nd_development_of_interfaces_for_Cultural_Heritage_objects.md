...
layout: trail
lang: en
translation_key: 4.1_second_TRAILs
title: Development of Interfaces for Cultural Heritage Objects, Measures, Protected Sites, and Citizen Science Data
start_date: 2026-01-01
end_date: ''
proposal_url: https://community.nfdi4objects.net/assemblies/SC/f/16/proposals/36?locale=en
type: n4o:Project
round: second
cochairs:
- name: Johanne Lefeldt
  person_ref: johannelehfeldt
- name: ''
  person_ref: ''
areas:
- ta4
...
- institut-fuer-archaaeologie-denkmalkunde-und-kunstgeschichte-universitaet-bamberg
- verband-der-landesarchaeologen-in-der-bundesrepublik-deutschland

focus_areas: ''
permalink: /en/trails/4.1_second_TRAILs/
---
## Description
