...
2. Zweitens bietet re3dragon eine [API](https://api.leiza.de/re3dragon/) für die Abfrage von verteilten LOD-Ressourcen. Von der API werden die Ergebnisse in einem standardisierten JSON-Format basierend auf [JSKOS](https://gbv.github.io/jskos/jskos.html) zurückgegeben. 
