...
short_title: 'Central service for <strong>long-term and secure archiving</strong> of archaeological research data with professional quality control workflows.'
...
The IANUS long-term archive and research data center can already be used by the community. Its infrastructure based on the **OAIS standard** ensures the long-term availability and reusability of research data. 
In the current pilot phase, data providers are invited to contact the project managers directly at ianus@dainst.de.
