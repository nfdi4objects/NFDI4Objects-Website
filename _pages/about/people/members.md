...
{% assign institutions = site.data.de.institutions | where: "type", "mainapplicant" %}
...
{% assign institutions = site.data.de.institutions | where: "type", "coapplicant" %}
...
{% include page-header.html
     title="Supporter"
     class="focus-white"
     subtitle="Die Unterstützer von NFDI4Objects"
%}

{% assign institutions = site.data.de.institutions | where: "type", "supporter" %}
