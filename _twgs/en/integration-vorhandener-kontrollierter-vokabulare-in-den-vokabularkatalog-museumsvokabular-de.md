...
The primary goal is to enhance the existing service “museumsvokabular.de” by adding new vocabularies that are currently not publicly accessible. These vocabularies should, at minimum, be made available under an open license (1-star according to the 5-star data model), such as downloadable PDF files, ensuring at least a readable understanding. 
