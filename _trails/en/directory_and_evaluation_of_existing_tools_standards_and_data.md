...
- bonn-center-for-digital-humanites-universität-bonn
...
The main focus is on the generation of documentation data (during field research), archiving and the work steps that take place in between, e.g. the processing (post-processing) of documentation data. The objective is a list of existing or used software tools, standards and documentation data and their evaluation.