...
lang: en
translation_key: community_clusters
permalink: /en/community/groups-networks/community-clusters/
---

{% include page-header.html
       icon="/assets/icons/infografik/Community.svg"
       title="What are Community Clusters"
...
{% include blocks/image-text-grid.html
   ...
   text="The Community Clusters (CC) are discussion forums on various topics related to research data management. They provide an open platform for all interested parties—both within and outside NFDI4Objects—to engage in dialogue. In addition to facilitating subject-specific exchange, they serve as hubs for networking and professional development. The Community Clusters support the consortium’s work program and enable the low-threshold integration of initiatives, needs, and impulses from the community."
   image_order="1"
   text_order="2"
%}
