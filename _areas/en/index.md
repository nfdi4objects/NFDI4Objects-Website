...
<section class="bg-sand-light-img">
    ...
    <p>
      {% if lang == 'en' %}
        The task areas (TA) structure the various areas of responsibility within the consortium.
        Everything you need to know about the task areas, the people responsible and employees, as well as news and activities, can be found here, listed according to the individual TAs.
      {% else %}
